...
void NinjaGirl::LoadNameSprites()
{
	...
	{
		m_vecDead.push_back(PATH_TO_RESOURCES		+ "/Heroes/NinjaGirl/Dead/Dead__00"				+ std::to_string(i) + ".png");
		m_vecIdle.push_back(PATH_TO_RESOURCES		+ "/Heroes/NinjaGirl/Idle/Idle__00"				+ std::to_string(i) + ".png");
		m_vecJump.push_back(PATH_TO_RESOURCES		+ "/Heroes/NinjaGirl/Jump/Jump__00"				+ std::to_string(i) + ".png");
		m_vecMelee.push_back(PATH_TO_RESOURCES		+ "/Heroes/NinjaGirl/Melee/Melee__00"			+ std::to_string(i) + ".png");
		m_vecRun.push_back(PATH_TO_RESOURCES		+ "/Heroes/NinjaGirl/Run/Run__00"				+ std::to_string(i) + ".png");
		m_vecSlide.push_back(PATH_TO_RESOURCES		+ "/Heroes/NinjaGirl/Slide/Slide__00"			+ std::to_string(i) + ".png");
		m_vecThrow.push_back(PATH_TO_RESOURCES		+ "/Heroes/NinjaGirl/Throw/Throw__00"			+ std::to_string(i) + ".png");
		m_vecThrowJump.push_back(PATH_TO_RESOURCES	+ "/Heroes/NinjaGirl/ThrowJump/ThrowJump__00"	+ std::to_string(i) + ".png");
		m_vecAttack.push_back(PATH_TO_RESOURCES		+ "/Heroes/NinjaGirl/Attack/Attack__00"			+ std::to_string(i) + ".png");
		m_vecAttackJump.push_back(PATH_TO_RESOURCES + "/Heroes/NinjaGirl/AttackJump/AttackJump__00" + std::to_string(i) + ".png");
	}
}
...
{
	this->setTexture(CCTextureCache::sharedTextureCache()->addImage(m_vecThrow[m_indexThrow]));
...
{
	this->setTexture(CCTextureCache::sharedTextureCache()->addImage(m_vecThrowJump[m_indexThrowJump]));
